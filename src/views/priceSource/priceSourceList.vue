      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="公司"> <a-input v-model="queryParam.company" placeholder=""/> </a-form-item> </a-col>
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="市级"> <a-input v-model="queryParam.municipallevel" placeholder=""/> </a-form-item> </a-col>
...
import { newPriceSource, editPriceSource, priceSourceList } from '@/api/priceSource'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return priceSourceList(requestParameters)
          .then(res => {
            return res.data
          })
      },
