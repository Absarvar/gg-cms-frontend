      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="对应商品id"> <a-input v-model="queryParam.goodsId" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="默认值"> <a-input v-model="queryParam.defaultVal" placeholder=""/> </a-form-item> </a-col>
...
import { newSku, editSku, skuList } from '@/api/sku'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return skuList(requestParameters)
          .then(res => {
            return res.data
          })
      },
