  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="流向"><a-input v-decorator="['flowdirection', {rules:[{required: true, message: '请输入流向'}]}]" /></a-form-item>
        ...
        <a-form-item label="会员id"><a-input v-decorator="['outletsid', {rules:[{required: true, message: '请输入会员id'}]}]" /></a-form-item>
...
// 表单字段
const fields = ['id', 'flowdirection', 'name', 'addtime', 'outletsid', 'terminalcode', 'status']
