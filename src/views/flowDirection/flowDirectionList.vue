...
import { newFlowDirection, editFlowDirection, flowDirectionList } from '@/api/flowDirection'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return flowDirectionList(requestParameters)
          .then(res => {
            return res.data
          })
      },
