  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="ID"><a-input v-decorator="['deviceid', {rules:[{required: true, message: '请输入ID'}]}]" /></a-form-item>
        ...
        <a-form-item label="创建时间"><a-input v-decorator="['addtime', {rules:[{required: true, message: '请输入创建时间'}]}]" /></a-form-item>
        <a-form-item label="入场id"><a-input v-decorator="['outletsid', {rules:[{required: true, message: '请输入入场id'}]}]" /></a-form-item>
        <a-form-item label="入库编号"><a-input v-decorator="['orderid', {rules:[{required: true, message: '请输入入库编号'}]}]" /></a-form-item>
...
// 表单字段
const fields = ['id', 'deviceid', 'devicecode', 'weight', 'devicename', 'price', 'rank', 'addtime', 'outletsid', 'orderid', 'status']
