...
import { newButcherEnt, editButcherEnt, butcherEntList } from '@/api/butcherEnt'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return butcherEntList(requestParameters)
          .then(res => {
            return res.data
          })
      },
