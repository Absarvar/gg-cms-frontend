      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="养殖营业执照上传"> <a-input v-model="queryParam.businesslicense" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="养殖单位"> <a-input v-model="queryParam.namefarm" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="养殖地址"> <a-input v-model="queryParam.farmaddress" placeholder=""/> </a-form-item> </a-col>
...
import { newFarm, editFarm, farmList } from '@/api/farm'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return farmList(requestParameters)
          .then(res => {
            return res.data
          })
      },
