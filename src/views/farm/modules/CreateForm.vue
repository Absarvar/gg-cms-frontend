  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="养殖营业执照上传"><a-input v-decorator="['businesslicense', {rules:[{required: true, message: '请输入养殖营业执照上传'}]}]" /></a-form-item>
        <a-form-item label="养殖单位"><a-input v-decorator="['namefarm', {rules:[{required: true, message: '请输入养殖单位'}]}]" /></a-form-item>
        <a-form-item label="养殖地址"><a-input v-decorator="['farmaddress', {rules:[{required: true, message: '请输入养殖地址'}]}]" /></a-form-item>
