  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="屠宰类型"><a-input v-decorator="['farmType', {rules:[{required: true, message: '请输入屠宰类型'}]}]" /></a-form-item>
        <a-form-item label="屠宰量（头/天）"><a-input v-decorator="['farmNum', {rules:[{required: true, message: '请输入屠宰量（头/天）'}]}]" /></a-form-item>
        <a-form-item label="场地面积"><a-input v-decorator="['farmArea', {rules:[{required: true, message: '请输入场地面积'}]}]" /></a-form-item>
...
// 表单字段
const fields = ['id', 'name', 'address', 'creditCode', 'peopleNum', 'linkman', 'linkmanMobile', 'farmType', 'farmNum', 'farmArea', 'aniQuarantineNo', 'farmBackupNo', 'businessLicense', 'relatedLicense', 'status']
