      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="商品数量"> <a-input v-model="queryParam.num" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="总重量"> <a-input v-model="queryParam.weight" placeholder=""/> </a-form-item> </a-col>
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="是否已消毒"> <a-input v-model="queryParam.disinfect" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="养殖票证"> <a-input v-model="queryParam.farmTicket" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="屠宰票证"> <a-input v-model="queryParam.quarantineTicket" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="地磅初读"> <a-input v-model="queryParam.checkLoad" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="地磅复读"> <a-input v-model="queryParam.recheckLoad" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="地磅重量"> <a-input v-model="queryParam.load" placeholder=""/> </a-form-item> </a-col>
