  ...
  >
    <a-spin :spinning="loading">
      <a-form :form="form" v-bind="formLayout">
        ...
        <a-form-item label="账号类型1肉类商户2终端用户"><a-input v-decorator="['accounttype', {rules:[{required: true, message: '请输入账号类型1肉类商户2终端用户'}]}]" /></a-form-item>
        <a-form-item label="身份类型1餐饮类2商超类3团餐类4学校类5机构类6综合配送-完成7市场类-完成8分割配送-完成"><a-input v-decorator="['identitytype', {rules:[{required: true, message: '请输入身份类型1餐饮类2商超类3团餐类4学校类5机构类6综合配送-完成7市场类-完成8分割配送-完成'}]}]" /></a-form-item>
        ...
        <a-form-item label="商户号"><a-input v-decorator="['shh', {rules:[{required: true, message: '请输入商户号'}]}]" /></a-form-item>
...
// 表单字段
const fields = ['id', 'terminalcode', 'corporatename', 'creditcode', 'accounttype', 'identitytype', 'legalperson', 'contacts', 'contactnumber', 'mailbox', 'region', 'address', 'companyprofile', 'addtime', 'shh', 'status']
