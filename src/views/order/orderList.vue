      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="订单总额"> <a-input v-model="queryParam.amount" placeholder=""/> </a-form-item> </a-col>
            ...
            <a-col :md="8" :sm="24"> <a-form-item label="更新时间"> <a-input v-model="queryParam.updateTime" placeholder=""/> </a-form-item> </a-col>
            <a-col :md="8" :sm="24"> <a-form-item label="地址"> <a-input v-model="queryParam.addressId" placeholder=""/> </a-form-item> </a-col>
...
import { newOrder, editOrder, orderList } from '@/api/order'
